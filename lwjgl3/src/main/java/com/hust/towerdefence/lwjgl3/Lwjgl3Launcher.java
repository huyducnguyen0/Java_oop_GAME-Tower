...
import static com.hust.towerdefence.MainGame.WORLD_HEIGHT;
import static com.hust.towerdefence.MainGame.WORLD_WIDTH;
...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        configuration.setWindowedMode((int)(WORLD_WIDTH * 70), (int)(WORLD_HEIGHT * 70));
